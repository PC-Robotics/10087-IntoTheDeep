...
public class ServoMotorPosConstants
{
    ...
    public static final int LINEAR_SLIDE_SPECIMEN_UPPER_POSITION = 1700;
    ...
    public static final double WRIST_INTAKE_POSITION = 0.81;
    public static final double WRIST_DRIVING_POSITION = 0.35;
    public static final double WRIST_RELEASE_POSITION = 0.07;

    public static final double BUCKET_PICKUP_POSITION = 0.514;
    public static final double BUCKET_RELEASE_POSITION = 0.48;

    public static final double LINEAR_SLIDE_POWER = 1;
